...
"")
        ...
        self.robotmaskthreshbox = QtWidgets.QSpinBox(self.trackerparamsframe)
        self.robotmaskthreshbox.setGeometry(QtCore.QRect(110, 160, 61, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setItalic(False)
        self.robotmaskthreshbox.setFont(font)
        self.robotmaskthreshbox.setStyleSheet("")
        self.robotmaskthreshbox.setMaximum(255)
        self.robotmaskthreshbox.setSingleStep(1)
        self.robotmaskthreshbox.setProperty("value", 128)
        self.robotmaskthreshbox.setObjectName("robotmaskthreshbox")
...
"            }")
        ...
        self.cellmaskthreshbox = QtWidgets.QSpinBox(self.trackerparamsframe)
        self.cellmaskthreshbox.setGeometry(QtCore.QRect(220, 160, 61, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setItalic(False)
        self.cellmaskthreshbox.setFont(font)
        self.cellmaskthreshbox.setStyleSheet("")
        self.cellmaskthreshbox.setMaximum(255)
        self.cellmaskthreshbox.setSingleStep(1)
        self.cellmaskthreshbox.setProperty("value", 128)
        self.cellmaskthreshbox.setObjectName("cellmaskthreshbox")
        ...
        self.label_10.setGeometry(QtCore.QRect(90, 50, 2, 231))
        ...
        self.robotmaskblocksizebox = QtWidgets.QSpinBox(self.trackerparamsframe)
        self.robotmaskblocksizebox.setGeometry(QtCore.QRect(110, 200, 61, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setItalic(False)
        self.robotmaskblocksizebox.setFont(font)
        self.robotmaskblocksizebox.setStyleSheet("")
        self.robotmaskblocksizebox.setMinimum(3)
        self.robotmaskblocksizebox.setMaximum(300)
        self.robotmaskblocksizebox.setSingleStep(1)
        self.robotmaskblocksizebox.setProperty("value", 11)
        self.robotmaskblocksizebox.setObjectName("robotmaskblocksizebox")
        self.cellmaskblocksizebox = QtWidgets.QSpinBox(self.trackerparamsframe)
        self.cellmaskblocksizebox.setGeometry(QtCore.QRect(220, 200, 61, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setItalic(False)
        self.cellmaskblocksizebox.setFont(font)
        self.cellmaskblocksizebox.setStyleSheet("")
        self.cellmaskblocksizebox.setMinimum(3)
        self.cellmaskblocksizebox.setMaximum(300)
        self.cellmaskblocksizebox.setSingleStep(1)
        self.cellmaskblocksizebox.setProperty("value", 11)
        self.cellmaskblocksizebox.setObjectName("cellmaskblocksizebox")
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.maskthreshlabel.setText(_translate("MainWindow", "Thresh"))
        ...
        self.maskthreshlabel_2.setText(_translate("MainWindow", "Block Size"))
