...
class ArduinoHandler:
    ...
    def send(self, Bx, By, Bz, alpha, gamma, freq, psi, gradient_status, equal_field_status, acoustic_freq) -> None:
        ...
        if self.conn is None:
            ...
            self.printer("No Connection:  "+ "[Bx, By, Bz, alpha, gamma, freq, psi, acoustic_freq, gradient, equal_field] = "+str(data)) 
            #pass
        else:
            #Bx = round(Bx,3)
            ...
            self.printer("Data Sent:  "+ "[Bx, By, Bz, alpha, gamma, freq, psi, acoustic_freq, gradient, equal_field] = "+str(data)) 
